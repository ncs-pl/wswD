...
Deno.test("Should copy content of tests/file.txt into new_file.txt", () => {
  const originalFilePath: string = resolvePath(import.meta.url, "../../tests/file.txt");
  const secondFilePath: string = resolvePath(import.meta.url, "../../tests/cp_test_file.txt");
